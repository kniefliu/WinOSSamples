...
SysMetricItem sysmetrics[] =
{
	...
	SM_CXMINSPACING, TEXT("SM_CXMINSPACING"), TEXT("Minimum window spacing width"),
	SM_CYMINSPACING, TEXT("SM_CYMINSPACING"), TEXT("Minimum window spacing height"),
...
SysMetricItemManager::SysMetricItemManager()
{
}

SysMetricItemManager* SysMetricItemManager::GetInstance()
{
	static SysMetricItemManager inst;
	return &inst;
}
	
int SysMetricItemManager::GetCount() const
{
	return NUMLINES;
}
const SysMetricItem& SysMetricItemManager::GetItem(int index) const
{
